            ...
            <section aria-labelledby="summary-heading" class="bg-tertiary-800 py-12 text-indigo-300 md:px-10 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:w-full lg:max-w-lg lg:bg-transparent lg:px-0 lg:pb-24 lg:pt-0">
                ...
                <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
                    ...
                    <x-checkout.product-list>
                        <x-checkout.product-item name="High Wall Tote" price="210,00" :features="['White and Black', '15L']" image="https://tailwindui.com/img/ecommerce-images/checkout-page-07-product-01.jpg" />
                    </x-checkout.product-list>
                        ...
                        <div class="mt-10">
                            ...
                            <div class="mt-6 grid grid-cols-3 gap-x-4 gap-y-6 sm:grid-cols-4">
                                ...
                                <div class="col-span-2 sm:col-span-3">
                                    <x-input-label for="expiration-date" class="block text-sm font-medium text-white" value="Data de
                                    expiração (MM/YY)" />

                                    <div class="mt-1">
                                        <x-text-input type="text" name="expiration-date" id="expiration-date" autocomplete="cc-exp" />
                                    </div>
                                </div>
                        ...
                        <div class="mt-10">
                            ...
                            <div class="mt-6 grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-3">
                                ...
                                <div class="sm:col-span-1">
                                    <x-input-label for="postal-code" class="block text-sm font-medium text-white" value="CEP" />
                                    <div class="mt-1">
                                ...
                                <div class="sm:col-span-3">
                                    <x-input-label for="address" class="block text-sm font-medium text-white" value="Rua" />
                                    <div class="mt-1">
                                ...
                                <div class="sm:col-span-1">
                                    <x-input-label for="number" class="block text-sm font-medium text-white" value="Número" />
                                    <div class="mt-1">
                                        <x-text-input type="number" id="number" name="number" autocomplete="address-level2" />
                                    </div>
                                </div>

                                <div class="sm:col-span-2">
                                    <x-input-label for="complemento" class="block text-sm font-medium text-white" value="Complemento" />
                                    <div class="mt-1">
                                        <x-text-input type="text" id="complemento" name="complemento" autocomplete="address-level1" />
                                    </div>
                                </div>

                                <div class="sm:col-span-2">
                                    <x-input-label for="city" class="block text-sm font-medium text-white" value="Cidade" />
                                    <div class="mt-1">
                                ...
                                <div>
                                    <x-input-label for="region" class="block text-sm font-medium text-white" value="Estado" />
                                    <div class="mt-1">
